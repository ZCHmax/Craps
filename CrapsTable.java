    ...
    implements ActionListener
{
    ...
    {
        int bet = Integer.parseInt(display.getBet().getText());
        int credit = Integer.parseInt(display.getCredit().getText());
        if (bet >= 1 && bet <= credit) {
            ...
            if (credit == 0) {
                ...
                JOptionPane.showMessageDialog(new JFrame(), "Please enter a bet between 1 and " + credit);
